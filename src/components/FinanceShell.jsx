...
const links = [
  ...
  { to: '/finance/mortgages', label: 'Mortgages' },
  { to: '/finance/escrow', label: 'Escrow' },
  { to: '/finance/rent-collection', label: 'Rent collection' },
  { to: '/finance/insurance', label: 'Insurance' },
  { to: '/finance/commissions', label: 'Commissions' },
]

export default function FinanceShell({ children, title, subtitle }) {
  return (
    <div className="min-h-screen bg-surface-subtle text-ink">
      <header className="border-b border-surface-border bg-surface">
        <div className="mx-auto flex max-w-page items-center justify-between px-6 py-4 lg:px-10">
          <Link to="/finance" className="text-lg font-bold text-brand-dark">Financial Services</Link>
