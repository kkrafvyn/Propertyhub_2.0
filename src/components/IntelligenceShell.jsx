...
const links = [
  ...
  { to: '/intelligence/heatmap', label: 'Price heatmap' },
  { to: '/intelligence/valuation', label: 'AI valuation' },
]

export default function IntelligenceShell({ children, title, subtitle }) {
  return (
    <div className="min-h-screen bg-surface-subtle text-ink">
      <header className="border-b border-surface-border bg-surface">
        <div className="mx-auto flex max-w-page items-center justify-between px-6 py-4 lg:px-10">
          <Link to="/intelligence" className="text-lg font-bold text-brand-dark">Real Estate Intelligence</Link>
