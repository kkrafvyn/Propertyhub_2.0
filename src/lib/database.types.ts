    ...
    Tables: {
      ...
      blockchain_records: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "blockchain_records_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "blockchain_records_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
      ...
      blockchain_verification_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "blockchain_verification_logs_blockchain_record_id_fkey"
          ...
          {
            foreignKeyName: "blockchain_verification_logs_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "blockchain_verification_logs_verified_by_fkey"
            columns: ["verified_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      blockchain_wallets: {
        ...
        Relationships: [
          {
            foreignKeyName: "blockchain_wallets_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      ownership_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "ownership_events_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ownership_events_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
            referencedRelation: "properties"
            referencedColumns: ["id"]
      ...
      smart_contract_events: {
        Row: {
          ...
          created_at: string | null
          decoded_params: Json | null
          event_name: string
          event_signature: string
          event_timestamp: number | null
          id: string
          indexed_params: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "smart_contract_events_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
      ...
      tokenized_assets: {
        ...
        Relationships: [
          {
            foreignKeyName: "tokenized_assets_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tokenized_assets_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
            referencedRelation: "properties"
            referencedColumns: ["id"]
      ...
      transaction_receipts: {
        ...
        Relationships: [
          {
            foreignKeyName: "transaction_receipts_blockchain_record_id_fkey"
            columns: ["blockchain_record_id"]
            isOneToOne: false
            referencedRelation: "blockchain_records"
            referencedColumns: ["id"]
      ...
      verification_hashes: {
        ...
        Relationships: [
          {
            foreignKeyName: "verification_hashes_blockchain_record_id_fkey"
            columns: ["blockchain_record_id"]
            isOneToOne: false
            referencedRelation: "blockchain_records"
            referencedColumns: ["id"]
