...
function buildDefaultTemplate(input: {
  ...
  return [
    `# ${input.title || heading}`,
    "",
    `Prepared by: ${input.organizationName || "BaytMiftah Workspace"}`,
    ...
    "## Terms",
    "",
    "1. The parties agree to proceed based on the listing and commercial terms captured in BaytMiftah.",
