export default {
  ...
  "roles": {
    ...
    "consumer": "مستهلك (شراء، إيجار، إيجار طويل، إقامة)",
  ...
  "messagesPage": {
    "title": "الرسائل",
    "subtitle": "تواصل مع المضيفين والوكلاء والمشترين.",
    "selectConversation": "اختر محادثة",
    "emptyInbox": "لا رسائل بعد",
    "emptyInboxHint": "راسل وكيلاً من أي إعلان لبدء محادثة.",
    "emptyThread": "قل مرحباً لبدء المحادثة.",
    "placeholder": "اكتب رسالة…",
    "send": "إرسال",
    "sending": "جارٍ الإرسال…",
    "opening": "جارٍ الفتح…",
    "defaultIntro": "مرحباً، أنا مهتم بـ {{title}}.",
    "viewListing": "عرض الإعلان",
    "live": "مباشر",
    "connecting": "جارٍ الاتصال…",
    "buyerThread": "استفسار المشتري",
    "agentInquiry": "الرد على هذا المشتري",
    "agentEmptyInbox": "لا رسائل من المشترين بعد",
    "agentEmptyInboxHint": "عندما يراسلك المشترون من إعلاناتك، ستظهر المحادثات هنا."
  },
  "vaultPage": {
  ...
  "integrations": {
    ...
    "paymentsHint": "الدفع المباشر يتطلب STRIPE_SECRET_KEY أو PAYSTACK_SECRET_KEY في أسرار Edge Functions.",
    "paymentDemo": "مزود الدفع غير مُعد. أضف أسرار الدفع في Supabase لتفعيل الدفع المباشر."
  },
  "legal": {
  ...
  "consumer": {
    "dashboard": {
      "title": "My BaytMiftah",
      "subtitle": "اشترِ، استأجر، أجر طويلاً، أو احجز إقامة قصيرة — حساب واحد لكل رحلة عقارية",
