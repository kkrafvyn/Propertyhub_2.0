export default {
  ...
  "mobile": {
    ...
    "viewList": "Lista",
    "resultsCount": "{{count}} propiedades",
  ...
  "roles": {
    ...
    "consumer": "Consumidor (comprar, alquilar, arrendar, estancia)",
  ...
  "messagesPage": {
    "title": "Mensajes",
    "subtitle": "Chatea con anfitriones, agentes y compradores.",
    "selectConversation": "Selecciona una conversación",
    "emptyInbox": "Sin mensajes aún",
    "emptyInboxHint": "Contacta a un agente desde cualquier anuncio para iniciar una conversación.",
    "emptyThread": "Saluda para comenzar la conversación.",
    "placeholder": "Escribe un mensaje…",
    "send": "Enviar",
    "sending": "Enviando…",
    "opening": "Abriendo…",
    "defaultIntro": "Hola, me interesa {{title}}.",
    "viewListing": "Ver anuncio",
    "live": "En vivo",
    "connecting": "Conectando…",
    "buyerThread": "Consulta del comprador",
    "agentInquiry": "Responder a este comprador",
    "agentEmptyInbox": "Sin mensajes de compradores",
    "agentEmptyInboxHint": "Cuando los compradores contacten tus anuncios, las conversaciones aparecerán aquí."
  },
  "vaultPage": {
  ...
  "integrations": {
    ...
    "paymentsHint": "El pago en vivo requiere STRIPE_SECRET_KEY o PAYSTACK_SECRET_KEY en secretos Edge Functions.",
    "paymentDemo": "El proveedor de pagos no está configurado. Añade los secretos en Supabase para habilitar el checkout."
  },
  "legal": {
  ...
  "consumer": {
    "dashboard": {
      "title": "My BaytMiftah",
      "subtitle": "Compra, alquila, arrienda o reserva estancias cortas — una cuenta para cada viaje inmobiliario",
