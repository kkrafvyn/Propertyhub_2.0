    ...
    <EnterpriseShell activeSection="Support" searchPlaceholder="Search resources...">
      <main className="bg-[#f5f7fc]">
        <section className="bg-[linear-gradient(110deg,#eaf2ff_0%,#f6f8ff_58%,#e9f7fb_100%)] px-5 py-16 text-center md:px-10">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3 text-sm">
              ...
              {topics.map((topic) => (
                <button key={topic} className="font-semibold text-[#007a52]">
                  {topic}
                </button>
              ))}
            </div>
        ...
        <section className="mx-auto grid max-w-6xl gap-6 px-5 py-14 md:px-10 lg:grid-cols-3">
          ...
          <article className="rounded-lg border border-[#b7e6dd] bg-[#e9fbf6] p-8">
            <div className="mb-8 grid h-12 w-12 place-items-center rounded-md bg-[#007a52] text-white">
            ...
            <div className="mt-28 border-t border-[#b7e6dd] pt-5">
              <button className="flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-[#007a52]">
                12 articles
          ...
          <article className="flex flex-col gap-6 rounded-lg border-l-4 border-[#007a52] bg-white p-8 shadow-sm lg:col-span-3 md:flex-row md:items-center md:justify-between">
            <div>
            ...
            <div className="flex flex-wrap gap-4">
              <button className="rounded-md bg-[#007a52] px-10 py-4 font-bold text-white">
                Open Live Chat
              </button>
        ...
        <footer className="border-t border-[#cbd3df] bg-white px-5 py-10 md:px-10">
          <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-8 text-sm">
            <strong className="text-2xl">Property Hub</strong>
            <span className="uppercase tracking-widest">Help Center</span>
            <span>Legal</span>
            <span>Privacy</span>
            <span>Cookies</span>
            <span>Security</span>
            <span className="ml-auto">© 2024 Property Hub Inc.</span>
          </div>
        </footer>
      </main>
    </EnterpriseShell>
