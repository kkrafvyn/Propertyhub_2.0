      ...
      <div className="relative overflow-hidden rounded-lg bg-[#dbeafe]">
        ...
        <div className="absolute left-5 top-5 flex flex-wrap gap-3">
          {listing.addressVerified && (
            <span className="rounded-full bg-[#62efad] px-4 py-2 text-sm font-bold text-[#006c48]">
              Address Verified
            </span>
          )}
          {listing.featured && (
      ...
      <div className="mt-6 grid gap-5 md:grid-cols-2">
        {items.map((amenity) => (
          <div key={amenity} className="flex items-center gap-3">
            <span className="material-symbols-outlined text-lg text-[#007a52]">
              check_circle
            </span>
    ...
    <section className="border-t border-[#cbd3df] pt-8">
      ...
      <div className="relative mt-6 overflow-hidden rounded-lg bg-[#8aa896]">
        ...
        <span className="absolute bottom-6 left-6 max-w-xs rounded-md bg-white px-5 py-3 text-sm shadow">
          ...
          <br />
          {listing.ghanaPostGps || 'Location verified by Property Hub'}
        </span>
      </div>
      ...
      <section className="rounded-lg border border-[#cbd3df] bg-white p-7 shadow-xl">
        <div className="flex items-start justify-between gap-4">
          ...
          <span className="flex items-center gap-1 text-sm">
            <span className="material-symbols-outlined text-base text-[#007a52]">star</span>
            {listing.rating}
          </span>
        </div>
        ...
        <div className="mt-6 space-y-3 border-b border-[#d8dde6] pb-5 text-sm">
          {[
            ['Agency', listing.organization?.name || 'Property Hub Partner'],
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          />
          <div>
            <h3 className="font-bold">{listing.organization?.name || 'Property Hub Partner'}</h3>
      ...
      <section className="rounded-lg border border-[#cbd3df] bg-[#edf4ff] p-6">
        ...
        {[
          ...
          <div key={label} className="mt-4 flex justify-between">
            <span>{label}</span>
            <strong className="text-[#007a52]">{value}</strong>
          </div>
        ))}
      </section>
    </aside>
    ...
    <div className="min-h-screen bg-[#f5f7fc] text-[#071121]">
      ...
      <main className="mx-auto max-w-7xl px-5 py-8 md:px-8">
        ...
        <div className="mt-3 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-sm font-bold uppercase tracking-widest text-[#007a52]">
          ...
          <section className="space-y-8">
            ...
            <section className="rounded-lg bg-[#111827] p-6 text-white">
              <h2 className="flex items-center gap-2 text-2xl font-bold">
                <span className="material-symbols-outlined text-[#62efad]">settings_input_antenna</span>
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                {[
                  ...
                  <article key={title} className="rounded-md border border-white/15 bg-white/5 p-4">
                    <span className="material-symbols-outlined text-[#62efad]">{icon}</span>
      ...
      <footer className="mt-16 bg-black px-8 py-12 text-white">
        <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-4">
          <div>
            <h2 className="text-2xl font-black">Property Hub</h2>
